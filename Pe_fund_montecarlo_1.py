...
with col_B:
    ...
    with st.container(border=True):
        mu_dist, mu_params = assumption_widget(
            ...
            defaults_by_dist={
                "Fixed":      {"value": 2.1},
                "Triangular": {"min": 0, "mode": 2.0, "max": 5},
                "Beta-PERT":  {"min": 0, "mode": 2.25, "max": 6},
                "Uniform":    {"min": 0, "max": 4.5},
                "Normal":     {"mean": 2.1, "std": 0.9, "max":5.5, "min":0},
                "Log-Normal": {"mean": 2.1, "std": 0.9, "max":5.5, "min":0},
    ...
    with st.container(border=True):
        mk_dist, mk_params = assumption_widget(
            ...
            defaults_by_dist={
                ...
                "Normal":     {"mean": 0.091, "std": 0.0536, "max":0.22, "min":-0.010},
                "Log-Normal": {"mean": 0.091, "std": 0.0536, "max":0.22, "min":-0.010},
