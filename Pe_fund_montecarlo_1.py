...
<div style="background:#0d1117;padding:22px 32px;border-radius:10px;margin-bottom:24px;">
  ...
  <p style="color:#dce7f2;margin:6px 0 0;font-size:14px;">
    This simulator builds on the paper <a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=1571249" target="_blank" style="color:#58a6ff;text-decoration:underline;">"Private Equity Returns: Estimates from 50 Million Funds"</a> by Stefano Bonini | Every assumption configurable as Fixed or stochastic
  </p>
</div>
""", unsafe_allow_html=True)
